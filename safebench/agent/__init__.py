...
if YoloAgent is not None:
    AGENT_POLICY_LIST['yolo'] = YoloAgent
if FasterRCNNAgent is not None:
    AGENT_POLICY_LIST['faster_rcnn'] = FasterRCNNAgent
